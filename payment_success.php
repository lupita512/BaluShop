								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Gracias </h1>
											<hr/>
											<p>Hola <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,tu pago ha sido realizado y completado 
											exitosamente y el ID de tu transacción es <b><?php echo $trx_id; ?></b><br/>
											tu puedes continuar comprando. <br/></p>
